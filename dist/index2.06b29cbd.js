...
})({"kwId6":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "823a55fc06b29cbd";
"use strict";
...
},{}],"2FPc1":[function(require,module,exports) {
...
const searchInputField = document.getElementById('search-country');
const submitButton = document.getElementById('submit-btn');
//eventlistener koppelen aan input field
searchInputField.addEventListener('keyup', handleSearch);
// submitButton.addEventListener('click', handleSearch);
function handleSearch(e) {
    //input opslaan in variabale
    let country = e.target.value;
    //alle landen ophalen via GET request
    async function fetchCountryInfo(country) {
        try {
            const resultArray = await _axiosDefault.default.get('https://restcountries.com/v2/all');
            const { data  } = resultArray;
            //met for-loop gezocht land presenteren op de pagina
            for(let i = 0; i < data.length; i++){
                if (data[i].name === country) {
                    countryInfo.innerHTML += `
                <p>
                <img src="${data[i].flag}" alt="Flag" class="flag">
                <span class="gochi-font">${data[i].name}</span>
                <br>
                <span>${data[i].name} is situated in ${data[i].subregion}. It has a population of ${data[i].population} people.</span>
                <br>
                <span>The capital is ${data[i].capital} and you can pay with ${data[i].currencies[0].name}'s.</span>
                <br>
                </p>
                `;
                }
            ...
            console.error(e + 'Fout in request');
        }
    }
    //functie starten nav zoekopdracht
...
},{}]},["kwId6","2FPc1"], "2FPc1", "parcelRequirecb08")

//# sourceMappingURL=index2.06b29cbd.js.map
