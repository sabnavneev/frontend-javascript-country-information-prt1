...
async function fetchCountryBySearch() {
    try {
        const result2 = await _axiosDefault.default.get('https://restcountries.com/v2/name/panama');
        // Haal data uit result
        const { data2  } = result2;
        console.log(result2);
        // Vul een html lijst met land info: flag, name, population
        countryInfo.innerHTML += `
                <li>
                <img src="${data2[0].flag}" alt="Flag" class="flag">
                <span>${data2[0].name} is situated in ${data2[0].subregion}. It has a population of ${data2[0].population} people.</span>
                <span>The capital is ${data2[0].capital} and you can pay with ${data2.currencies[0]}'s</span>
                <span>and you can pay with ${data2[0].currencies[0]} and ${data2[0].currencies[1]}'s</span>
                </li>
                `;
    } catch (e) {
        console.error(e);
...
},{}]},["j2JkV","5mvL2"], "5mvL2", "parcelRequirecb08")

//# sourceMappingURL=index2.58d620de.js.map
